...
class Account(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    aws_account_id: Mapped[Optional[str]] = mapped_column(
    ...
    provisioned_product_id: Mapped[Optional[str]] = mapped_column(
        String(128), nullable=True
    )
    oidc_provider_arn: Mapped[Optional[str]] = mapped_column(
